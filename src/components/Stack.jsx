      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
          {stack.categories.map((category) => {
            ...
            } else if (category.id === "backend" || category.id === "database") {
              icon = (
            ...
            } else if (category.id === "cloud" || category.id === "devops") {
              icon = (
            ...
            return (
              <div key={category.id} className="min-w-0 p-6 sm:p-8 glass rounded-xl">
                {icon}
                ...
                <div className="flex flex-wrap gap-2">
                  {category.items.map((item, i) => (
                    <span
                      key={i}
                      className="max-w-full break-words px-3 py-1 bg-white/5 border border-white/10 rounded-md text-sm"
                    >
                      {item}
                    </span>
                  ))}
